...
int main()
{
    ...
    cout << "Enter node values (-1 for NULL node): " << endl;
    ...
    auto duration_bfs =
        duration_cast<microseconds>(stop_bfs - start_bfs);

    cout << "\nExecution time for BFS: "
         << duration_bfs.count()
         << " microseconds" << endl;
    ...
    auto duration_dfs =
        duration_cast<microseconds>(stop_dfs - start_dfs);

    cout << "\nExecution time for DFS: "
         << duration_dfs.count()
         << " microseconds" << endl;
